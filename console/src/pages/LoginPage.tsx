...
export const LoginPage = () => {
  ...
  const { loading, error, deviceUuid, isAuthenticated } = useSelector((state: RootState) => state.auth);
  ...
  useEffect(() => {
    const initDevice = async () => {
      if (!deviceUuid) {
        await dispatch(createDeviceUuid({
        ...
        <div className="relative">
          ...
          <div className="p-8">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-gray-400">Build and deploy your React applications with ease.</p>
            </div>
          </div>
        </div>
      </div>
